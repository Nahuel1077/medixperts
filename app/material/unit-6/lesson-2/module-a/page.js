...
const lessonData = {
  id: "unit6-title",
  unitTitle: "Module A: Discharge Instructions",
  description: "",
  nextLesson: "/material/unit-6/lesson-2/module-b",
  prevLesson: "/material/unit-6/lesson-2",
    ...
    return(
        <div className="flex xl:flex-row flex-col bg-black">
            ...
            <Class lessonData={lessonData}>
              <Link href="https://drive.google.com/uc?export=download&id=1e6NrbrrItpQVY9MVd6Iet7qKbMI2hKXp" 
