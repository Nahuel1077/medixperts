...
export default function AboutUs() {
  ...
  return (
    <div className="bg-linear-to-t from-white to-[#e7e7e7] text-black flex flex-col">
      <Nav></Nav>
        <div className="flex flex-col items-center justify-center pt-[100px] gap-10 sm:gap-20">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-start">
                ...
                <div className="flex flex-col gap-4 items-center">
                    ...
                    <h2 className={montserrat.className + " sm:text-2xl font-bold underline"}>Nahuel Ezequiel Henríquez</h2></Link>
